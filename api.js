...
request.open('GET', 'https://www.purpleair.com/json?show=62141', true)
request.onload = function () {
  ...
  // pm25value0 = parseInt(data.results[0].PM2_5Value); 
  // pm25value1 = parseInt(data.results[1].PM2_5Value);
  // pm25value = (pm25value0 + pm25value1)/2;
